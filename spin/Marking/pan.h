...
#define _nstates5	11	/* p4 */
#define minseq5	240
#define maxseq5	249
#define _endstate5	10

#define _nstates4	111	/* p3 */
#define minseq4	130
#define maxseq4	239
#define _endstate4	110

#define _nstates3	11	/* p2 */
#define minseq3	120
#define maxseq3	129
#define _endstate3	10

#define _nstates2	75	/* p1 */
#define minseq2	46
#define maxseq2	119
#define _endstate2	74

#define _nstates1	12	/* :init: */
#define minseq1	35
#define maxseq1	45
#define _endstate1	11

#define _nstates0	36	/* task_runner */
#define minseq0	0
#define maxseq0	34
...
#define Air1	(sizeof(P1) - Offsetof(P1, _2_1_i) - 1*sizeof(int))

#define Ptask_runner	((P0 *)_this)
typedef struct P0 { /* task_runner */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
