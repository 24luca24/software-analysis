...
public class IpServer extends JFrame {
    ...
    public IpServer(int impo) throws SQLException {
        ...
        ip.setText(client.GetIp());  // Initialize ip with the client's IP
     ...
     * <code>impostazioni</code> fosse diverso da 1, altrimenti verr&agrave; cancellato il testo prensente nel pannello .
